...
#import "NSDate+SCFHelper.h"

@implementation NSDate (SCFHelper)
...
- (NSString*)countDown {
    ...
    if([self hoursAfter] > 0) {
        countDownStr = [countDownStr stringByAppendingString:[NSString stringWithFormat:@"%ld小时",(long)[self hoursAfter]]];
    }
    
    if([self minutesAfter] > 0) {
        countDownStr = [countDownStr stringByAppendingString:[NSString stringWithFormat:@"%ld分",(long)[self minutesAfter]]];
    }
    
    if ([self secondsAfter] > 0) {
        countDownStr = [countDownStr stringByAppendingString:[NSString stringWithFormat:@"%ld秒",(long)[self secondsAfter]]];
    }
